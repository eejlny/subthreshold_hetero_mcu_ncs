...
#tflite_convert --output_file=./tflite/merged.tflite \
#--graph_def_file=./data/UCI_HAR_Dataset_output/merged_dcl.pb --inference_input_type=QUANTIZED_UINT8 \
#--inference_type=QUANTIZED_UINT8 \
#--input_shapes=1,128,3 --input_arrays=main_input1 \
#--output_arrays=softmax/Softmax \
#--default_ranges_min=0 --default_ranges_max=1 --mean_values=0 --std_dev_values=255 \
#--change_concat_input_ranges=false \
#--allow_nudging_weights_to_use_fast_gemm_kernel=true \
#--allow_custom_ops

tflite_convert --output_file=./tflite/merged.tflite \
--graph_def_file=./data/UCI_HAR_Dataset_output/merged_dcl.pb \
--inference_type=QUANTIZED_UINT8 \
--input_shapes=1,128,3 --input_arrays=main_input1 \
--output_arrays=softmax/Softmax \
--default_ranges_min=0 --default_ranges_max=1 --mean_values=0 --std_dev_values=255 \
...
xxd -i ./tflite/merged.tflite > ./tflite/con1d_activity_model.cc
